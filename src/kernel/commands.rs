...
pub(super) fn connect(invite: String) -> Command<KernelEffect, KernelMsg> {
    Command::new(|ctx| async move {
...
pub(super) fn sync_routes() -> Command<KernelEffect, KernelMsg> {
    Command::new(|ctx| async move {
...
pub(super) fn serve(listen: SocketAddr, accept_count: usize) -> Command<KernelEffect, KernelMsg> {
    Command::new(|ctx| async move {
...
pub(super) fn generate(num_events: usize, event_size: usize) -> Command<KernelEffect, KernelMsg> {
    Command::new(|ctx| async move {
...
pub(super) fn replay_dependent_events_reverse() -> Command<KernelEffect, KernelMsg> {
    Command::new(|ctx| async move {
        let summary = match ctx
...
pub(super) fn count() -> Command<KernelEffect, KernelMsg> {
    Command::new(|ctx| async move {

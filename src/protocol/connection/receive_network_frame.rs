//! Inbound network-frame classifier.
//!
...
//! frames, validate child facts itself, or decide durability.
//!
...
// emits durable observation or receipt facts as needed. Established frame
// projectors also stage opened child facts back into incoming projection.
// Opening is transport decoding, not protocol validation; the child projectors
// still own semantic validation and retention.

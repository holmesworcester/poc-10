//! Observed endpoint-address surface.
//!
//! This is connection-maintenance-owned derived state, not a fact family: it
//! records the last reachable listen address learned for a endpoint so a
//! membership connection can find a known endpoint after an invite link expires.

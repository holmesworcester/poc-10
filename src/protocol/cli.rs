...
use crate::core::cli::{
    decode_hex_32_named as decode_hex_32, encode_hex, encode_hex_32, CliArgs, CliOutput,
};
...
fn replay_check_output(report: &crate::core::replay::ReplayCheckReport) -> CliOutput {
    let mut lines = vec![
        ...
        format!("state_hash: {}", encode_hex(&report.canonical_hash)),
...
fn state_summary_output(summary: &StateSummary) -> CliOutput {
    let mut lines = vec![
        format!("state_hash: {}", encode_hex(&summary.state_hash)),

...
use crate::protocol::fact_modules::sync_encrypted_root::{
    layout as encrypted_root_layout, project as encrypted_root_project,
};
use crate::protocol::fact_modules::sync_key_wrap_available::layout as key_wrap_available_layout;
use crate::protocol::fact_modules::sync_shared_event::layout as shared_event_layout;
        ...
        for root in roots {
            ...
            if dep_ready && key_ready {
                output = output.intent(
                    crate::protocol::intent_handlers::transit::send_on_connection_intent(
                        crate::protocol::intent_handlers::transit::TransitSendOnConnection {

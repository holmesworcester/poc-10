...
use crate::protocol::fact_modules::encryption;
...
fn decrypt_text(message: &SealedMessageFact, secret_payload: &Fact) -> Result<String, String> {
    ...
    let plaintext = crypto::xchacha20poly1305_decrypt(
        &key,
        &crate::protocol::fact_modules::sealed_message::create::associated_data(
            message.workspace_id,
            message.frontier_id,
            message.minute,
        ),
    ...
    crate::protocol::fact_modules::sealed_message::create::recover_text(&plaintext)
}

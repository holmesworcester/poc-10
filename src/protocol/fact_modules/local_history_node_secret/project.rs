...
impl Projector for LocalHistoryNodeSecretProjector {
    fn project(
        ...
        let frontier_need = crate::protocol::matchers::exact_event_need(
            fact.id,
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::local_history_node_secret::fact::{
        LocalHistoryNodeSecretFact, NODE_SECRET_BYTES, TRIE_LEAF_BIT_DEPTH,
    };
    use topo::protocol::fact_modules::local_history_node_secret::{layout, project, rows};
    use topo::protocol::fact_modules::removal_frontier::fact::RemovalFrontierFact;
    use topo::protocol::fact_modules::removal_frontier::layout as frontier_layout;

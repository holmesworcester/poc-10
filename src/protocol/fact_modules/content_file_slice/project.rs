...
fn validate_file_deletion(
    ...
    let deletion =
        crate::protocol::fact_modules::content_file_deletion::layout::decode_fact(&payload.bytes)
            .map_err(|_| {
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::content_file_slice::{layout, project, rows};

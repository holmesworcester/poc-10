...
use crate::protocol::fact_modules::transit_received::layout as receive_layout;
...
impl Projector for ConnectionRequestProjector {
    fn project(
        ...
        let invite_need =
            matchers::connection_invite_secret_need(fact.id, request.invite_secret_event_id);
        ...
        if received.transit_kind
            != crate::protocol::fact_modules::transit_received::fact::TRANSIT_KIND_BOOTSTRAP
        {
...
fn validate_invite_signature(
    request: &ConnectionRequestFact,
    invite_secret: &crate::protocol::fact_modules::identity_invite::fact::InviteSecretFact,
) -> Result<(), String> {

...
use crate::protocol::fact_modules::identity_endpoint_shared::layout as endpoint_shared_layout;
use crate::protocol::fact_modules::identity_user::layout as user_layout;
use crate::protocol::fact_modules::identity_user_invite::layout as user_invite_layout;
use crate::protocol::fact_modules::identity_workspace::layout as workspace_layout;
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::identity_device_invite::fact::DeviceInviteFact;
    use topo::protocol::fact_modules::identity_device_invite::{layout, project, rows};
    use topo::protocol::fact_modules::identity_endpoint_shared::{
    ...
    use topo::protocol::fact_modules::identity_user_invite::{
    ...
    fn device_invite_projector_materializes_row_through_atomic_intent() {
        ...
        assert_eq!(row.user_authority_event_id, scenario.user_fact.id);
        assert_eq!(row.user_invite_event_id, Some(scenario.user_invite_fact.id));

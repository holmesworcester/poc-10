...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::content_message::{layout, project, rows};
    use topo::protocol::fact_modules::content_message_deletion::fact::ContentMessageDeletionFact;
    use topo::protocol::fact_modules::content_message_deletion::layout as deletion_layout;
    ...
    fn content_message_keeps_deletion_watch_and_deletes_when_matched() {
        ...
        let deleted = bus
            .drain_applying_atomic_rows(
                ...
                &[
                    rows::CONTENT_MESSAGE_ROWS,
                    topo::protocol::fact_modules::content_message_deletion::rows::MESSAGE_DELETION_ROWS,
                ],
                10,
            )
    ...
    impl topo::core::projection::Projector for CombinedProjector {
        fn project(
            ...
            if deletion_layout::decode_fact(&fact.bytes).is_ok() {
                topo::protocol::fact_modules::content_message_deletion::project::ContentMessageDeletionProjector::new()

...
use crate::protocol::fact_modules::encryption::fact::NO_PREVIOUS_RECIPIENT_KEY;
use crate::protocol::fact_modules::encryption::intent::materialize_key_wraps_intent;
use crate::protocol::fact_modules::encryption::layout;
...
fn validate_previous_recipient_key(
    previous_fact: &Fact,
    recipient: &crate::protocol::fact_modules::encryption::fact::RecipientKeyFact,
) -> Result<(), String> {

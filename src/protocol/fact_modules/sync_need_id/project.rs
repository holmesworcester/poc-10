...
//! with the requested event bytes if this store has them.

use crate::core::facts::Fact;
use crate::core::intents::AtomicIntent;
use crate::core::projection::{ProjectionContext, ProjectionOutput, Projector};
use crate::protocol::intent_handlers::handle_sync::{
    respond_to_sync_need_intent, RespondToSyncNeed,
};
...
impl Projector for SyncNeedIdProjector {
    fn project(
        ...
        Ok(ProjectionOutput::new()
            ...
            .intent(respond_to_sync_need_intent(RespondToSyncNeed {
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::sync_need_id::fact::SyncNeedIdFact;
    use topo::protocol::fact_modules::sync_need_id::{layout, project, rows};

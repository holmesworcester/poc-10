//! Build a `connection_response` fact from validated handshake inputs.
//!
...
//! `Fact::new` construction and crypto helpers stay outside `src/protocol/intent_handlers/`
...
use super::layout;
use crate::protocol::fact_modules::connection_ephemeral_secret::fact::ConnectionEphemeralSecretFact;
use crate::protocol::fact_modules::connection_request::fact::ConnectionRequestFact;
use crate::protocol::fact_modules::identity_endpoint::fact::EndpointFact;
use crate::protocol::fact_modules::identity_invite::fact::InviteSecretFact;
...
///
/// `request_id` is the fact id of the inbound `connection_request` fact;
...
/// and `responder_ephemeral_secret_event_id` pins which (future) ephemeral
...
pub struct BuildResponderResponse<'a> {
    ...
    pub responder_ephemeral_secret_event_id: [u8; 32],

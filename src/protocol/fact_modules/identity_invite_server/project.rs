...
use crate::protocol::fact_modules::identity_admin::layout as admin_layout;
...
impl Projector for InviteServerProjector {
    fn project(
        ...
        Ok(output
            .offer(crate::protocol::matchers::invite_server_offer(fact.id))
            .offer(crate::protocol::matchers::invite_server_key_offer(
                fact.id,
...
fn decode_admin_payload(
    fact: &Fact,
) -> Result<crate::protocol::fact_modules::identity_admin::fact::AdminFact, String> {
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::identity_invite_server::fact::InviteServerFact;
    use topo::protocol::fact_modules::identity_invite_server::{layout, project, rows};

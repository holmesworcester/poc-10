...
//! the advertised event if it is not already present locally.

use crate::core::facts::Fact;
use crate::core::intents::AtomicIntent;
use crate::core::projection::{ProjectionContext, ProjectionOutput, Projector};
use crate::protocol::intent_handlers::handle_sync::{request_sync_id_intent, RequestSyncId};
...
impl Projector for SyncHaveIdProjector {
    fn project(
        ...
        Ok(ProjectionOutput::new()
            ...
            .intent(request_sync_id_intent(RequestSyncId {
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::sync_have_id::fact::SyncHaveIdFact;
    use topo::protocol::fact_modules::sync_have_id::{layout, project, rows};

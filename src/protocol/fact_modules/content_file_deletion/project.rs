...
use crate::protocol::fact_modules::content_file::layout as file_layout;
...
impl Projector for ContentFileDeletionProjector {
    fn project(
        ...
        let target_need = crate::protocol::matchers::exact_event_need(
            fact.id,
            scope.clone(),
...
mod projector_tests {
    ...
    use topo::protocol::fact_modules::content_file_deletion::fact::ContentFileDeletionFact;
    use topo::protocol::fact_modules::content_file_deletion::{layout, project, rows};

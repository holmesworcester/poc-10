...
use crate::protocol::identity::admin::fact::AdminFact;
use crate::protocol::identity::user;
use crate::protocol::identity::workspace;
...
fn materialized_output(
    ...
    Ok(output
        ...
        .offer(crate::core::context::ContextOffer::range(
            fact.id,
            "identity_admin",
            crate::protocol::identity::workspace::scope(admin.workspace_id),
            admin.user_fact_id,
            admin.user_fact_id,
        ))
...
fn decode_user_payload(
    fact: &Fact,
) -> Result<crate::protocol::identity::user::fact::UserFact, String> {
    match fact.bytes.first().copied() {

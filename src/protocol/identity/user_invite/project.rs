...
use crate::protocol::identity::user_invite::fact::UserInviteFact;
use crate::protocol::identity::{admin, endpoint_shared, workspace};
...
fn materialized_output(
    ...
    Ok(output
        ...
        .offer(crate::core::context::ContextOffer::range(
            fact.id,
            "identity_user_invite_key",
            crate::protocol::identity::workspace::scope(invite.workspace_id),
...
fn decode_admin_payload(
    fact: &Fact,
) -> Result<crate::protocol::identity::admin::fact::AdminFact, String> {

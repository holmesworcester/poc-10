...
pub fn start_compare_fact_with_summary(
    ...
    Ok(Fact::new(
        FactScope::Global,
        0,
        super::encode::encode_fact(&compare)?,
    ))
}
...
fn is_sync_control_fact(fact: &Fact) -> bool {
    matches!(
        ...
        Some(super::encode::TYPE_SYNC_COMPARE)
            | Some(sync::have_id::encode::TYPE_SYNC_HAVE_ID)
            | Some(sync::need_id::encode::TYPE_SYNC_NEED_ID)
    )
}
...
fn compare_response_fact(
    ...
    Ok(Fact::new(
        ...
        super::encode::encode_fact(&SyncCompareFact {
            connection_id,
            range,
            summary,
...
mod tests {
    ...
    fn compare_fact(
        ...
        Fact::new(
            FactScope::Global,
            0,
            super::super::encode::encode_fact(&SyncCompareFact {
                connection_id: [7; 32],
                range,
                summary,
                response_requested,

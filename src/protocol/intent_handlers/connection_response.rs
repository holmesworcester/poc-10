...
// `fact_modules::connection_response::create`. The cleanliness guardrail
// keeps fact construction and AEAD / HKDF helpers under
// `src/protocol/fact_modules/`; the handler stays a bounded effect that wires
...
use crate::protocol::fact_modules::connection_response::create::{
    build_responder_response, BuildResponderResponse,
};
use crate::protocol::fact_modules::identity_endpoint::layout as endpoint_layout;

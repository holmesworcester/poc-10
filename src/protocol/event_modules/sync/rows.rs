...
//! to `NEGENTROPY_PENDING_PURGES` and append its row-table rows to
//! `SCHEMAS`.
//!
...
//! and is not itself a canonical event with layout/projector behavior.
//!
//! Schema:
...
/// `protocol::event_modules::schemas` next to other module rows lists.

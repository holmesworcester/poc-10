...
pub fn send(
    ...
    args: CliArgs<'_>,
) -> Result<CommandOutput<message::author::SendReceipt>, String> {
...
pub fn send_output(receipt: &message::author::SendReceipt, text: &str) -> CliOutput {
    CliOutput::lines(vec![
...
pub fn generate(
    ctx: &CommandContext<'_>,
    args: CliArgs<'_>,
) -> Result<CommandOutput<message::author::GenerateReceipt>, String> {
...
pub fn generated_output(
    receipt: &message::author::GenerateReceipt,
    applied_facts: usize,
) -> CliOutput {
    CliOutput::lines(vec![
        format!("workspace_id: {}", encode_hex_32(&receipt.workspace_id)),

...
impl crux_core::Effect for ProtocolEffect {}

impl From<Request<StoreOp>> for ProtocolEffect {
    fn from(request: Request<StoreOp>) -> Self {
        Self::Store(request)
    }
}

impl From<Request<NetworkOp>> for ProtocolEffect {
    fn from(request: Request<NetworkOp>) -> Self {
        Self::Network(request)
    }
}

impl From<Request<StdoutOp>> for ProtocolEffect {

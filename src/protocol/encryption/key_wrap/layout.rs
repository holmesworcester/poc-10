//! Fixed-width layout for key wrap facts and key-wrap coordinate keys.
...
pub fn history_node_key_wrap_coordinate_key(
    ...
    crate::protocol::encryption::local_history_node_secret::layout::validate_history_node_coordinate(
        range_start,
        range_width,
        bit_depth,
        fact_id_prefix,

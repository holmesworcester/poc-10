...
impl TypedProjector<super::Codec> for LocalHistoryNodeSecretProjector {
    fn project_typed(
        ...
        let workspace_scope = crate::protocol::identity::workspace::scope(node.workspace_id);
        ...
        Ok(waiting
            ...
            .offer(crate::protocol::encryption::coverage::secret_offer(
                fact.id,
                workspace_scope,
                node.workspace_id,
                node.removal_frontier_id,
...
mod projector_tests {
    ...
    use topo::protocol::encryption::fact::LocalKeySecretFact;
    use topo::protocol::encryption::layout as encryption_layout;
    use topo::protocol::encryption::local_history_node_secret::fact::{
        LocalHistoryNodeSecretFact, NODE_SECRET_BYTES, TRIE_LEAF_BIT_DEPTH,
    };
    use topo::protocol::encryption::local_history_node_secret::{layout, project, rows};
    use topo::protocol::encryption::removal_frontier::fact::RemovalFrontierFact;
    use topo::protocol::encryption::removal_frontier::layout as frontier_layout;

...
pub const FACTS: &[FactRegistration] = &[
    ...
    FactRegistration {
        ...
        tag: sync::layout::TYPE_SYNC_RANGE_REQUEST,
        projector: "SyncContextProjector",
    },
    FactRegistration {
        module: "sync",
        name: "encrypted_root",
        tag: sync::layout::TYPE_ENCRYPTED_ROOT,
        projector: "SyncContextProjector",
    },
    FactRegistration {
        module: "sync",
        name: "shared_event",
        tag: sync::layout::TYPE_SHARED_EVENT,
        projector: "SyncContextProjector",
    },
    FactRegistration {
        module: "sync",
        name: "key_wrap_available",
        tag: sync::layout::TYPE_KEY_WRAP_AVAILABLE,
        projector: "SyncContextProjector",
    },
    FactRegistration {
        module: "sync_compare",

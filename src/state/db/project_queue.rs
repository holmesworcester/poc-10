...
mod tests {
    ...
    // Wave 1 cleanup: `test_claim_batch_treats_encrypted_file_slice_as_bulk`
    // was deleted because the file_slice event type has been removed; the
    // bulk-lane demotion path has no remaining client.
}

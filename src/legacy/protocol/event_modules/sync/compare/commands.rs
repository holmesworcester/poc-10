...
pub struct SyncReport {
    ...
    pub events: Vec<crate::legacy::protocol::event_modules::types::EventRecord>,
...
) -> Result<Vec<crate::legacy::protocol::event_modules::types::EventRecord>, String> {
...
mod tests {
    ...
    use crate::legacy::protocol::event_modules::types::EventIndexEntry;

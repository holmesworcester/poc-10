...
fn project_admin(
    ...
    Ok(ProjectionOutput::table_writes(vec![rows::admin_row(
        admin.workspace_id,
        admin_id,
        admin.created_at_ms,
        admin.public_key,
...
#[cfg(test)]
mod tests {
    use crate::legacy::protocol::event_modules::identity::{signed, user, workspace};
    ...
    fn rejects_raw_admin_at_protocol_admission_boundary() {
        ...
        let err = crate::legacy::protocol::event_modules::event_from_bytes(record.canonical_bytes)

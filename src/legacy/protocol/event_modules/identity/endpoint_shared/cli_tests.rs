...
use crate::legacy::protocol::event_modules::worker::{self, AdmitRecords, DrainUntilIdle};
use crate::legacy::protocol::event_modules::Modules;
...
impl commands::EndpointMembershipRead for NoMembership {
    fn endpoint_membership(
        ...
        _workspace_id: crate::legacy::protocol::event_modules::types::EventId,

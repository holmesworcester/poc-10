...
#[cfg(test)]
mod tests {
    use crate::legacy::protocol::event_modules::identity::endpoint_shared::commands;
    ...
    impl commands::EndpointMembershipRead for ReadContext {
        fn endpoint_membership(
            &self,
            _endpoint_id: crate::legacy::protocol::event_modules::identity::endpoint::types::EndpointId,
            _workspace_id: [u8; 32],
    ...
    fn signed_context<'a>(
        ...
        record: &'a crate::legacy::protocol::event_modules::types::EventRecord,
        device_invite_id: [u8; 32],
        device_invite_record: crate::legacy::protocol::event_modules::types::EventRecord,
    ) -> EventWithContext<'a> {
        EventWithContext {
            record,

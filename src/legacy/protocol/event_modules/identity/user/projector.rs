...
use crate::legacy::protocol::event_modules::identity::{signed, user_invite};
...
mod tests {
    ...
    fn workspace_id() -> crate::legacy::protocol::event_modules::types::EventId {
        ...
        let bytes =
            crate::legacy::protocol::event_modules::identity::workspace::layout::encode(&workspace)
    ...
    fn signed_user_record(
        signer_event_id: crate::legacy::protocol::event_modules::types::EventId,
        signer_private_key: &[u8; 32],
        workspace_id: crate::legacy::protocol::event_modules::types::EventId,
        username: &str,
    ) -> Record {
    ...
    fn rejects_wrong_signer_dependency_type() {
        ...
        let workspace_record =
            crate::legacy::protocol::event_modules::identity::workspace::layout::record_from_bytes(
                crate::legacy::protocol::event_modules::identity::workspace::layout::encode(
                    &workspace,
                )
                .expect("encode workspace"),
            )

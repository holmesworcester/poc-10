...
//! term.
//!
//! `removal_event_ids` is a frontier set, not a full history list. These ids are
//! the compact refs whose dependency closure represents removals incorporated by
//! this frontier. The field is fixed-width on the wire; commands split unusually
//! large concurrent bursts into multiple frontier events and return the final
//! root id.

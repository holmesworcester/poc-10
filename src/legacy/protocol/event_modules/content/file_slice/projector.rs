...
use crate::legacy::protocol::event_modules::content::file;
use crate::legacy::protocol::event_modules::content::file_deletion::types::deletion_label_author as file_deletion_label_author;
...
mod tests {
    ...
    fn rejects_slice_whose_proof_does_not_match_descriptor_root_hash() {
        ...
        built.slice_event_id = crate::legacy::protocol::event_modules::types::event_id(&bytes);

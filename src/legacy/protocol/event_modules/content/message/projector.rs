...
use crate::legacy::protocol::event_modules::content::message_deletion::types::deletion_label_author;
use crate::legacy::protocol::event_modules::disappearing_messages_setting;
...
use crate::legacy::protocol::event_modules::types::{EventId, EventRecord};
...
mod tests {
    ...
    fn setting_record_with_ttl(workspace_id: [u8; 32], ttl_minutes: u32) -> Record {
        use crate::legacy::protocol::event_modules::encryption::disappearing_messages_setting as setting;
    ...
    fn purges_message_on_project_when_self_deletion_label_is_present() {
        use crate::legacy::protocol::event_modules::content::message_deletion::types::deletion_label;
    ...
    fn raw_message_bytes_are_not_admissible() {
        ...
        assert_eq!(
            crate::legacy::protocol::event_modules::event_from_bytes(payload)

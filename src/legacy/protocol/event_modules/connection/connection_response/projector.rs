...
use super::commands;
use super::layout;
use crate::legacy::protocol::event_modules::types::ReceiveAuthorization;
...
pub fn project(event: &EventWithContext<'_>) -> Result<ProjectionOutput, String> {
    ...
    let invite_secret = crate::legacy::protocol::event_modules::identity::invite::layout::decode(
...
mod tests {
    ...
    use crate::legacy::protocol::event_modules::connection::connection_ephemeral_secret;
    use crate::legacy::protocol::event_modules::connection::connection_response::types::ResponseEvent;
    use crate::legacy::protocol::event_modules::connection::{connection_request, rows};
    use crate::legacy::protocol::event_modules::identity::invite;
    use crate::legacy::protocol::event_modules::types::event_id;
    use crate::legacy::protocol::event_modules::types::ReceiveMetadata;

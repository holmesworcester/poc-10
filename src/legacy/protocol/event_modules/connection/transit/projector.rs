...
use crate::legacy::protocol::event_modules::identity::endpoint::types::{
    EndpointId, EndpointKeypair,
};
use crate::legacy::protocol::event_modules::identity::{self, endpoint, invite};
use crate::legacy::protocol::event_modules::rows as event_schema;
use crate::legacy::protocol::event_modules::sync;
use crate::legacy::protocol::event_modules::types::{EventId, ReceiveMetadata};
use crate::legacy::protocol::event_modules::worker::{ProjectionOutput, ReceivedRecord};
...
mod tests {
    ...
    use crate::legacy::protocol::event_modules::connection::transit;

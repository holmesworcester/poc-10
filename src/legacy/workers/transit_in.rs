...
mod tests {
    ...
    use crate::legacy::protocol::event_modules::identity::{endpoint, invite};
    use crate::legacy::protocol::Protocol;
    use crate::legacy::workers::pipeline_helpers::event_pipeline as pipeline;
    ...
    fn bootstrap_request_drain_uses_canonical_queue_boundary() {
        ...
        let frame =
            crate::legacy::protocol::event_modules::connection::transit::commands::create_bootstrap(
                &bob,
                alice.endpoint,
                &request_bytes,
            )

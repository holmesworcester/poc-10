...
use crate::legacy::protocol::event_modules::connection::{rows, transit, types};
use crate::legacy::protocol::event_modules::identity::endpoint;
use crate::legacy::protocol::event_modules::identity::endpoint::types::EndpointId;
use crate::legacy::protocol::event_modules::queries as event_queries;
use crate::legacy::protocol::event_modules::sync::SyncIndex;
...
pub(crate) fn drain_and_wrap_transit_out_for_connection(
    ...
    let connection =
        crate::legacy::protocol::event_modules::connection::connection_response::layout::decode(
            &connection_event,
        )

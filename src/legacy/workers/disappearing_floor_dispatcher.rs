...
//! test in `src/legacy/workers/encryption.rs` covers the primitive's contract).
//!
...
use crate::legacy::daemon::{self, StepContext, Worker};
use crate::legacy::protocol::event_modules::content::message::types::UNIX_MINUTE_MS;
use crate::legacy::protocol::event_modules::encryption::disappearing_messages_setting::queries as setting_queries;
use crate::legacy::protocol::event_modules::encryption::disappearing_messages_setting::rows as setting_schema;
use crate::legacy::protocol::event_modules::encryption::disappearing_messages_setting::types::COVER_HORIZON_MINUTES;
use crate::legacy::protocol::event_modules::encryption::removal_frontier::queries as frontier_queries;
use crate::legacy::protocol::event_modules::identity::workspace::queries as workspace_queries;
use crate::legacy::protocol::event_modules::types::EventId;
use crate::legacy::workers::encryption as encryption_worker;
use crate::legacy::workers::pipeline_helpers::event_pipeline::EventRegistry;
use crate::legacy::workers::DaemonWorkerContext;
...
mod tests {
    ...
    use crate::legacy::protocol::event_modules::encryption::local_key_secret;
    use crate::legacy::protocol::event_modules::encryption::removal_frontier;
    use crate::legacy::protocol::event_modules::identity::workspace::rows as workspace_schema;
    use crate::legacy::protocol::event_modules::types::{event_id, EventId, EventStatus};
    use crate::legacy::protocol::Protocol;
    ...
    /// Mirror of the helper in `src/legacy/workers/encryption.rs` tests: build a
    ...
    ) -> crate::legacy::protocol::event_modules::types::EventRecord {
        let payload =

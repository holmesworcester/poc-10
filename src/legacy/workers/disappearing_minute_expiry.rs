...
use crate::legacy::protocol::event_modules::content::message::rows as message_schema;
use crate::legacy::protocol::event_modules::content::message::types::{
    message_event_id_in_minute, UNIX_MINUTE_MS,
};
use crate::legacy::protocol::event_modules::content::reaction::queries as reaction_queries;
use crate::legacy::protocol::event_modules::content::reaction::types::reaction_event_id_in_minute;
...
use crate::legacy::workers::event_retention;
    ...
    R: EventRegistry,
{
    ...
    if job_count > 0 {
        let cascade = crate::legacy::workers::content_purge::run(
            store,
            registry,
            crate::legacy::workers::content_purge::Work::Drain { limit: usize::MAX },
        )
...
fn process_job<R: EventRegistry>(
    ...
    // `message::rows::message_tombstone_exists`), and purge the

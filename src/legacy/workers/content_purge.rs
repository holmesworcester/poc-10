...
#[cfg(test)]
mod tests {
    use crate::legacy::protocol::event_modules::content::message::types::MessagePlaintext;
    use crate::legacy::protocol::event_modules::content::reaction::types::ReactionPlaintext;
    use crate::legacy::protocol::event_modules::rows::{self as event_schema, ContextUpdate};
    ...
    fn message_record(text: &str) -> crate::legacy::protocol::event_modules::types::EventRecord {

...
use crate::legacy::protocol::event_modules::identity::{
    endpoint, endpoint_shared, invite_accepted,
};
use crate::legacy::protocol::event_modules::queries as event_queries;
use crate::legacy::protocol::event_modules::sync::commands;
pub use crate::legacy::protocol::event_modules::sync::commands::{
    SyncSelection, SyncStartReport, SyncWorkReport,
};
use crate::legacy::protocol::event_modules::sync::compare;
use crate::legacy::protocol::event_modules::sync::compare::commands::ReadContext;
use crate::legacy::protocol::event_modules::sync::compare::types::{RangeSummary, TimestampRange};
use crate::legacy::protocol::event_modules::sync::rows as negentropy_purges;
use crate::legacy::protocol::event_modules::types::{EventId, EventIndexEntry};
use crate::legacy::workers::pipeline_helpers::event_pipeline::{CommandOutput, ProposedEvent};
use crate::legacy::workers::queue_rows as worker_rows;
use crate::legacy::workers::{
    pipeline_helpers::event_pipeline as event_worker, DaemonWorkerContext,
};
...
impl IndexState {
    ...
    fn dependencies_for(
        ...
        let record = crate::legacy::protocol::event_modules::event_from_bytes(bytes)?;
...
mod tests {
    ...
    use crate::legacy::protocol::event_modules::sync::queries as negentropy_purge_queries;
    use crate::legacy::protocol::event_modules::sync::{compare, have_id};
    use crate::legacy::protocol::event_modules::types::{
        event_id, ConnectionScope, EventId, EventScope,
    };
    use crate::legacy::protocol::event_modules::worker as event_worker;

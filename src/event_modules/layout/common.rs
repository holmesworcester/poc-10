...
pub fn encrypted_inner_wire_size(inner_type_code: u8) -> Option<usize> {
    ...
    use super::super::message::codec::MESSAGE_WIRE_SIZE;
    ...
    match inner_type_code {
        ...
        // Wave 1: file(24), file_slice(25), admin(18), bench_dep(26) dropped.
...
mod tests {
    ...
    fn test_per_event_wire_sizes() {
        ...
        assert_eq!(REACTION_WIRE_SIZE, 266);
        assert_eq!(WORKSPACE_WIRE_SIZE, 137);
        assert_eq!(USER_WIRE_SIZE, 234);
        assert_eq!(PEER_SHARED_WIRE_SIZE, 266);
        assert_eq!(KEY_SECRET_WIRE_SIZE, 73);
        assert_eq!(MESSAGE_DELETION_WIRE_SIZE, 202);
        assert_eq!(INVITE_ACCEPTED_WIRE_SIZE, 105);
        assert_eq!(USER_INVITE_WIRE_SIZE, 202);
        assert_eq!(DEVICE_INVITE_WIRE_SIZE, 202);
        assert_eq!(TENANT_WIRE_SIZE, 41);
        assert_eq!(KEY_SHARED_WIRE_SIZE, 459);
        assert_eq!(INVITE_SECRET_WIRE_SIZE, 105);
        assert_eq!(KEY_REQUEST_WIRE_SIZE, 330);
        assert_eq!(IDENTITY_PUBKEY_SIGNED_WIRE_SIZE, 138);
    }
    ...
    fn test_encrypted_inner_wire_size_known() {
        use super::super::super::message::codec::MESSAGE_WIRE_SIZE;
        use super::super::super::reaction::REACTION_WIRE_SIZE;
        ...
        // Wave 1: file(24), file_slice(25), bench_dep(26) reserved -> None
        assert_eq!(encrypted_inner_wire_size(24), None);
        assert_eq!(encrypted_inner_wire_size(25), None);
        assert_eq!(encrypted_inner_wire_size(26), None);
    }
    ...
    fn test_encrypted_wire_size_message() {
        ...
        assert_eq!(encrypted_wire_size(REACTION_WIRE_SIZE), 336);
    }
}

...
use crate::event_modules::encryption::fact::{LocalHistoryNodeSecretFact, LocalKeySecretFact};
use crate::event_modules::encryption::{layout, matchers};
use crate::event_modules::local_history_node_secret::fact::{
    mask_prefix_to_depth, TIME_TREE_BIT_DEPTH, TRIE_LEAF_BIT_DEPTH,
};
use crate::event_modules::local_history_node_secret::matchers as history_matchers;
use crate::event_modules::sealed_message;

use super::project_helpers::{matched_payload_fact, require_local_scope};
...
pub(super) fn project_local_key_secret(
    ...
    let scope = sealed_message::matchers::workspace_scope(secret.workspace_id);
...
pub(super) fn project_local_history_node_secret(
    ...
    let scope = sealed_message::matchers::workspace_scope(node.workspace_id);
    require_local_scope(fact)?;

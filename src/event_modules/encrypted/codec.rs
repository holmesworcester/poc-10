...
use super::super::{EventError, ParsedEvent, EVENT_TYPE_ENCRYPTED};
...
impl super::super::Describe for EncryptedEvent {
    fn human_fields(&self) -> Vec<(&'static str, String)> {
        ...
        vec![
            ...
            ("ciphertext", super::super::trunc_hex(&self.ciphertext, 40)),
        ]
    }
}
...
pub static ENCRYPTED_META: EventTypeMeta = EventTypeMeta {
    ...
    // `encrypted` is a wrapper type — it owns no projection table; the
    // inner event's projector handles persistence.
    ensure_schema: None,
};

...
pub fn signer_role() -> Role {
    Role::new("signer_pubkey").expect("valid signer role")
}

pub fn secret_role() -> Role {
    Role::new("secret_coverage").expect("valid secret coverage role")
}
...
pub fn signer_need(owner: FactId, scope: FactScope, signer_id: SignerId) -> ContextNeed {
    ContextNeed {
        owner,
        role: signer_role(),
        scope,
...
pub fn signer_offer(owner: FactId, scope: FactScope, signer_id: SignerId) -> ContextOffer {
    ContextOffer {
        owner,
        role: signer_role(),
        scope,

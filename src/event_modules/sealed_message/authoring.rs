...
use crate::event_modules::{encryption, identity_endpoint, identity_workspace, signed_fact};
...
impl SealedMessageVault {
    pub fn for_workspace(
        ...
        let endpoint = identity_endpoint::local_endpoint::local_endpoint(runtime.store())?
            .ok_or_else(|| "local endpoint is not initialized".to_string())?;
        identity_workspace::local_membership::local_membership(runtime.store(), workspace_id)?

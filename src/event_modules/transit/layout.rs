//! Fixed-width wire layouts for poc-10 transit frames.
//!
...
/// Plaintext capacity of a small transit frame (4 KiB).
///
...
/// Plaintext capacity of a large transit frame (1 MiB).
///
...
/// Fixed-width small transit frame.
...
/// Fixed-width large transit frame.
#[derive(Debug, Clone, PartialEq, Eq)]

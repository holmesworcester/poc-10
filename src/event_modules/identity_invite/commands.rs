...
pub fn create_device_link(
    ...
    let device_invite_bytes = crate::event_modules::signed_fact::create::sign_payload_bytes(
...
pub fn create_invite_server(
    ...
    let invite_server_bytes = crate::event_modules::signed_fact::create::sign_payload_bytes(
        authority.signer_id,
        &local.signing_secret,

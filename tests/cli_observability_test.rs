...
#[ignore = "poc-8 #61: legacy observability features (sub/event/stats/replay/connections) require legacy DB schema and projection tables that no longer exist in the substrate-only build"]
#[test]

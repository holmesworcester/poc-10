...
#[ignore = "poc-8 #61: full invite-link flow requires legacy identity-chain projection (workspace::commands::create_workspace_for_db) which references removed columns"]
#[test]

...
#[ignore = "poc-8 #61: invite-link discovery requires legacy invite-link projector"]
#[test]
...
fn test_cli_local_mdns_discovery_without_bootstrap_addresses() {
    ...
    wait_for_endpoint_observation(&bob.db, &alice_peer_id, std::time::Duration::from_secs(120));

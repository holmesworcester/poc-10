...
/// Wave 1: file/file_slice/bench_dep/admin event modules dropped.
const CANONICAL_EVENT_FILES: &[&str] = &[
    "src/event_modules/message/codec.rs",
    "src/event_modules/reaction/codec.rs",
    "src/event_modules/encrypted/codec.rs",
    "src/event_modules/message_deletion/codec.rs",
    "src/event_modules/key_secret/codec.rs",
    "src/event_modules/key_request/codec.rs",
    "src/event_modules/key_shared/codec.rs",
    "src/event_modules/workspace/codec.rs",
    "src/event_modules/invite_accepted/codec.rs",
    "src/event_modules/user_invite_shared/codec.rs",
    "src/event_modules/user/codec.rs",
    "src/event_modules/peer_invite_shared/codec.rs",
    "src/event_modules/peer_shared/codec.rs",
    "src/event_modules/invite_secret/codec.rs",
];
...
fn all_registered_types_have_fixed_wire_size() {
    ...
    let reg = registry();
    for code in 1u8..=30 {
        // Wave 1: 18 (admin), 24 (file), 25 (file_slice), 26 (bench_dep) reserved.
        if matches!(
            code,
            3 | 4 | 11 | 13 | 15 | 17 | 18 | 19 | 20 | 21 | 23 | 24 | 25 | 26
        ) {

...
fn protocol_version_flexibility_design_is_local_and_poc10_specific() {
    ...
    for required in [
        ...
        "TreeKEM",
        "**Read before production write.**",
        "Write paths may exist in alpha, dogfood, integration tests, and fixtures",
        "Production write UI and command creation stay runtime-gated",
        ...
        "global compatibility epochs plus read-before-prod-write and replay-on-upgrade",

...
fn protocol_version_flexibility_research_is_local_and_poc10_specific() {
    ...
    for required in [
        ...
        "Retention and purge rules must be represented as durable facts or explicit absence semantics",
        ...
        "old adapters are easier and safer than lenses because they preserve the original canonical bytes and hash identity",

...
fn protocol_versioning_design_is_local_and_poc10_specific() {
    ...
    for required in [
        ...
        "lens.rs",
        "provenance-preserving ceiling input",
        "### Phase 4a",
        ...
        "unsafe interpretation in lenses or policy facts",
        "### Phase 5",
        "### Phase 6",
        "### Phase 7",
...
fn protocol_versioning_doc_surfaces_current_audit_gaps_first() {
    ...
    for required in [
        ...
        "A lens consumes already-validated historical evidence",
        "Quarantine boundary",
        "local-only, connection- or audience-scoped, quota-bounded, not shared onward",
        "Read-model changes",

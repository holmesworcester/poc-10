...
fn core_readmes_document_runtime_and_pipeline_boundaries() {
    ...
    for required in [
        ...
        "pipeline.rs",
        "public facade for fact lifecycle contracts, route metadata, projection context/output types",
        ...
        "### Pipeline Sections",
        "readable n=1 work items live in `project_fact.rs` and `handle_intent.rs`",
        "pipeline.rs::route",

...
fn core_readmes_document_runtime_and_pipeline_boundaries() {
    ...
    for required in [
        ...
        "`authenticate` means family-owned fact-boundary proof",
        "Detached signature evidence is itself a fact that authenticates independently and then offers context",
        ...
        "Recurring intents are live-only daemon work",

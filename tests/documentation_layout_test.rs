...
fn architecture_diagrams_are_github_flowcharts_for_current_context_architecture() {
    ...
    for required in [
        ...
        "projector router",
        "handler registry",
        "recurring intent builders",
        "serialized runtime turn",
        "runtime store and queues",
        "command/query path",
        "query pre-settle: retained projection only",
        "daemon tick path",
        "fire recurring local intents",
        ...
        "AuthoredCommand facts",
        "RuntimeEffects",
        "incoming_facts",
        "`RuntimeEffects::incoming_facts` in the temporary `incoming_facts` queue",
        "runtime drains those rows straight into the owning projector",
        "pending_projection retained queue",
        "incoming_facts temporary queue",
        "incoming ready scan",
        "load incoming fact plus matched context",
        "incoming projector output",
        "delete incoming_facts row",

...
fn protocol_version_flexibility_design_is_local_and_poc10_specific() {
    ...
    for required in [
        ...
        "publish the richest fact plus bounded fallback view facts",
        "v3, v2-view, and v1-view facts together",
        "bounded multi-publish across still-supported view versions",
        ...
        "Sync should keep facts in the same presentation group close together",
        ...
        "presentation group, scope, audience, and view version",
        ...
        "Recommended maximal path: use versioned scope manifests, explicit degradation lenses, multi-publish view versions",

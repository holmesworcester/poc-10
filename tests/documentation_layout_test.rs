...
fn protocol_version_flexibility_design_is_local_and_poc10_specific() {
    ...
    for required in [
        ...
        "publish every non-deprecated released view version",
        "Each release manifest records the previous release view versions it can read",
        "missing durable representations should converge deterministically",
        ...
        "one highest-common version for a closed set",
        "all non-deprecated release view versions for an open-ended audience",
        ...
        "typed degradation lens from the richest command or fact to each non-deprecated release view version",
        "explicit unsupported-activity fact in an authorized parent scope",
        "one author-certified representation set",
        "For open-ended audiences, publish the richest/source fact plus every non-deprecated release-view sibling",
        "omit a sibling only when every included active device can read a richer sibling",
        "Projectors verify the representation-set proof, scope, audience, version-graph dominance, and hash links",
        ...
        "Deprecation stops new writes of that release-view sibling",

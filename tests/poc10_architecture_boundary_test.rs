...
fn poc10_success_criteria_are_recorded_in_architecture_doc() {
    ...
    let required = [
        ...
        "the daemon hands accepted bytes to the protocol-declared inbound intake",
        "the connection scope classifies the frame, emits the right local wrapper fact",
        "wrapper fact and observation fact",
        ...
        "Connection facts preserve the durable relationship",

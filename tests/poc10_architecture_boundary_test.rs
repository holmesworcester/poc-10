...
fn poc10_connection_request_projection_excludes_wire_transport() {
    ...
    // lives in connection/request/transit.rs and the receive handler.
    ...
    assert!(
        ...
        "connection_request projection must stay on the canonical request fact; wire seal/open transport belongs to connection/request/transit.rs:\n{}",

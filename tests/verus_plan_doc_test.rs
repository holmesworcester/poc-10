...
fn core_proofs_make_trust_boundary_explicit() {
    ...
    let required = [
        ...
        "`Projector::project_with_witness`",
        "`ProjectionRouteWitness`",
        "same route",
        "selection that calls the projector",
...
fn verus_plan_is_single_core_first_source() {
    ...
    let required = [
        ...
        "`Projector::project_with_witness` returns a",
        "`ProjectorRun` containing the existing `ProjectionOutput` plus optional route",
        "`RouterProjector`",
        "`ProjectionRouteWitness { fact_id, effective_tag, route_tag,",
